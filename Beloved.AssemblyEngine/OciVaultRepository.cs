...
namespace Beloved.AssemblyEngine
{
    ...
    public class OciVaultRepository : IVaultRepository
    {
        ...
        public Task<(string targetDirectory, string digest)> FetchModuleAsync(string moduleName, string tag, string targetDirectory) => FetchModuleAsync(moduleName, tag, targetDirectory, CancellationToken.None);
        public async Task<(string targetDirectory, string digest)> FetchModuleAsync(string moduleName, string tag, string targetDirectory, CancellationToken cancellationToken)
        {
        ...
        public Task<(Dictionary<string, byte[]> files, string digest)> FetchModuleInMemoryAsync(string moduleName, string tag) => FetchModuleInMemoryAsync(moduleName, tag, CancellationToken.None);
        public async Task<(Dictionary<string, byte[]> files, string digest)> FetchModuleInMemoryAsync(string moduleName, string tag, CancellationToken cancellationToken)
        {
        ...
        public async Task<bool> VerifySignatureAsync(string moduleName, string version, CancellationToken cancellationToken)
        {
            try
            {
                var repository = $"modules/{moduleName.ToLower()}";
        ...
        public async Task<IEnumerable<string>> ListModulesAsync(CancellationToken cancellationToken)
        {
